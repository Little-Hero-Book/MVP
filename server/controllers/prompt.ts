...
const role = `
You are a Children’s Picture Book Creator — a creative writer who specializes in crafting short, warm, adventurous stories for children ages 3–8. Your writing is fun, visual, emotionally safe, and suitable for read-aloud bedtime moments. You use the structure of classic children’s stories as inspiration while customizing the story to feature the child as the hero.
`;
...
2. Required JSON structure:
{
  "stories": [
    {
      "title": "Story Title",
      "gist": "2-3 sentence summary with moral",
      "pageTexts": [
        "50-80 word text for page 1",
        "50-80 word text for page 2",
        "50-80 word text for page 3",
        "50-80 word text for page 4"
      ],
      "illustrationPrompts": [
        "Page 1 visual: [description with FAVORITE_COLOR and FAVORITE_THING]",
        "Page 2 visual: [description with FAVORITE_COLOR and FAVORITE_THING]",
        "Page 3 visual: [description with FAVORITE_COLOR and FAVORITE_THING]",
...
4. Favorite Thing must appear in at least one illustration prompt
5. Favorite Color must be prominent in all illustrations
`;

const examples = `
EXAMPLE OUTPUT for input {Name: Leo, Favorite Thing: Magic Cape, Favorite Color: Blue}:
{
  "stories": [
    {
      "title": "Leo and the Nightlight Dragon",
      "gist": "When the nightlights go out, brave Leo uses his magic cape to...",
      "pageTexts": [
        "Leo was putting on his blue pajamas when...",
        "The dragon's scales shimmered blue as Leo...",
        "Wrapping his magic cape tightly, Leo...",
        "With one final swish of his cape..."
      ],
      "illustrationPrompts": [
        "Leo in blue pajamas holding magic cape, staring at dark bedroom window",
        "Blue-scaled dragon curled around a streetlight, Leo approaching with cape",
        "Close-up of Leo's blue cape glowing as he stands on dragon's nose",
...
export const storyHistory = [
  {
    ...
    2. BOTH arrays must contain EXACTLY 4 items per story
    3. EVERY illustration prompt must reference the Favorite Color
    4. AT LEAST ONE prompt per story must show the Favorite Thing
    5. Maintain consistent character traits throughout`,
  },
];
